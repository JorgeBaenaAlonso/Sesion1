...
int main(int argc, char **argv) {
  ...
  do {
    ...
    cout << "\tAficionados en la pila -> " << 0 /*gestor.AficionadosEnPila()*/
         ...
         << 0 /*gestor.SociosEnCola() */ << "\tSimpatizantes-> "
         << 0 /*gestor.SimpatizantesEnCola() */
         << " \n\tAficionados en la lista -> "
         << 0 /*gestor.AficionadosEnLista()*/
    ...
    cout << "\tA. Generar 10 Aficionados de forma aleatoria y almacenarlos en "
            "la "
            "Pila.\n";
    ...
    cout << "\tM. Mostrar los datos de todos los simpatizantes ordenados "
            "por sus IDs de menor a mayor.\n";
    cout << "\tN. Mostrar los datos de todos los Aficionados recorriendo el "
            "arbol "
            "en inorden.\n";
    cout << "\tO. Buscar en el ABB el primer Aficionado, "
            "el ultimo socio, el primer simpatizante y "
            "el ultimo Aficionado que acceden al estadio.\n";
    cout << "\tP. Mostrar el numero de aficionados en el ABB cuyos ID's son "
            "pares.\n";
    cout << "\tQ. Mostrar los aficionados que se encuentran almacenados en un "
            "nodo hoja.\n";
    cout << "\tR. Eliminar un aficionado indicado por su ID. Mostrar el arbol "
            "antes y despues tras la eliminacion de dicho aficionado.\n";
    cout << "\tS. Salir.\n\n";
